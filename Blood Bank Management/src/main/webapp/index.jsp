...
<body>
 ...
 {
	 %>
	 <center><font color = "red" size="5">Form submitted succesfully,you will be notified soon in 24 hrs</font></center>
  <% 
 }
 %>
 <%
 ...
 <input type="text" name="mobileno" placeholder=" Enter Mobile " required>
 <input type="mail" name="email" placeholder=" Enter Email " required>
 <input type="text" name="bloodgrp" placeholder=" Enter Blood Group" required>
